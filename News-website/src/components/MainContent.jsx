    ...
    const fetchArticles = async () => {
      ...
      try {
        ...
        if (error.response) {
          ...
          setError(`Error loading news: ${error.response.status} ${error.response.statusText}`);
        } else if (error.request) {
          // Request was made but no response was received
          setError("Error loading news: No response from server");
        } else {
